...
typedef void (*sd_result_step_cb_t)(size_t step, uint8_t* image_data, void* data);
...
SD_API void sd_ctx_set_result_step_callback(sd_ctx_t* sd_ctx, sd_result_cb_t cb, void* data);
