...
// List available ggml backend devices to stdout, one `name<TAB>description`
// per line. The names are the device names accepted by the --backend /
// --params-backend assignment specs.
