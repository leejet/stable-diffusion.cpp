...
STABLE_DIFFUSION_API void set_txt2img_sample_method(sd_txt2img_options *opt, SampleMethod sample_method);
...
STABLE_DIFFUSION_API void set_img2img_sample_method(sd_img2img_options *opt, SampleMethod sample_method);
...
STABLE_DIFFUSION_API int load_from_file(void *sd, const char *file_path, Schedule schedule);
...
STABLE_DIFFUSION_API void set_stable_diffusion_log_level(SDLogLevel level);
